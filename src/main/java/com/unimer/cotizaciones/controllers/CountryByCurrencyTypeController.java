...
public class CountryByCurrencyTypeController {
	...
	public String addCountryByCurrencyType(ModelMap modelSession,@ModelAttribute("userSession") UserSession userSession,@RequestParam("idCountry") int idCountry,@RequestParam("idCurrencyType") int idCurrencyType) {
